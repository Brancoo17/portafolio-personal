document.addEventListener('DOMContentLoaded', function () {
  ...
  var translations = {
    es: {
      ...
      gym_title: "Sistema de Gestión para Gimnasio",
      ...
      gym_problem: "Los gimnasios suelen controlar membresías y pagos en planillas de Excel o cuadernos, sin aviso automático quiénes están al día y quiénes no. Armar los horarios de clases y asignar entrenadores se hace a mano, y no hay un lugar único donde el cliente vea sus planes, sus turnos y su estado de pago.",
      ...
      gym_result: "El sistema permitió a los gimnasios gestionar sus membresías y pagos de manera eficiente, reducir el tiempo dedicado a la coordinación de horarios y mejorar la experiencia del cliente al proporcionar un acceso claro a su información y planes."
    },
    en: {
      nav_about: "About",
      nav_stack: "Stack",
      ...
      gym_result: "The system enabled gyms to efficiently manage memberships and payments, reduce the time spent coordinating schedules, and improve the customer experience by providing clear access to their information and plans."
    }
  };
